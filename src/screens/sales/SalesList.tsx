...
import PayeModal from './PayeModal';
...
const SalesList = ({
  ...
  const handleShowFactureModal = React.useCallback(
    (sale: Sale) => async () => {
      ...
      setFacture({ ...sale.facture, seller: sale.seller } as any);
    },
    []
  );
    ...
    () => [
      {
        ...
        renderCell: (params: GridRenderCellParams<any>) => (
          ...
          >
            <ShoppingBasketIcon sx={{ fontSize: 24 }} color="primary" />
          </Stack>
        ),
      },
      ...
      },
      {
        ...
        getActions: (params: GridRowParams<Sale>) => [
          ...
          <GridActionsCellItem
            ...
            showInMenu
            disabled={params.row.facture.amountDue <= 0 || currentUser?.user.role !== 'SUPER_ADMIN'}
          />,
        ],
      },
    ],
